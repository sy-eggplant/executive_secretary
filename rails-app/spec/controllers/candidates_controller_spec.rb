...
RSpec.describe CandidatesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new candidate" do
        ...
        expect(response.location).to eq(candidate_url(Candidate.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new candidate" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the candidate" do
        candidate = Candidate.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the candidate" do
        candidate = Candidate.create! valid_attributes
